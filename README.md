...
**바로가기:** [학창시절](#학창시절) | [VR굴착기](#VR굴착기) | [업무경력](#업무경력)
--- 
### 학창시절
...
해당 도전을 진행하면서, 저는 새로운 분야의 도전에 임하는 자세를 배우게 되었으며, 자신이 이루려고 하는 **`목표를 위하여 해결해야 할 것들을 하나하나 정의하고, 해결하는 마인드셋`** 을 갖추게 되었습니다.<br/>
...
### 업무경력
- `2019.01~현재` 설계보조 프로그램 개발/유지보수
- `2019.06` NX-IPS프로그램 리뉴얼 (호스 시뮬레이션 설계보조 프로그램, VB-->Python 번역작업 및 UI개선, 기능추가 등)
- `2019.08` ~~2D도면 Attribute 자동작성 프로그램 개발~~ (2D도면 작성 보조 프로그램이나, 효과가 크지않아 반려되어 미배포)
- `2020.02` NX10버전 호환성 대응 (설계보조프로그램 약 7종 호환성 업데이트 진행)
- `2020.01~2020.10` 산학과제 F/U (다발호스 시뮬레이션 설계보조 프로그램 개발, 호스금구 응력계측 및 시뮬레이션 방법 개발)
- `2020.01~2020.05` 유압호스 2D도면 자동작성 프로그램 개발 F/U (프로그램 사양서, UI, 알고리즘, 등을 정하여 개발 의뢰 진행)
- `2020.01~현재` O-RING 자동추가 프로그램 개발 (유압파이프에 스펙에 맞는 O-RING을 자동으로 추가하는 프로그램 개발 중)
- `2021.02~현재` 다발호스 시뮬레이션 프로그램 리뉴얼 (호스 설계보조 프로그램, VB-->Python 번역작업 및 UI개선, 기능추가 등)
