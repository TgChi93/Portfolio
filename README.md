...
- `2020.01~2020.05` 유압호스 2D도면 자동작성 프로그램 개발 F/U (프로그램 사양서, UI, 알고리즘, 등을 정하여 개발 의뢰 및 결과물 테스트 진행)
- `2020.01~현재` 유압파이프 O-RING 자동추가 프로그램 개발 (유압파이프에 스펙에 맞는 O-RING을 자동으로 추가하는 프로그램 개발 중)
